...
import { getTravelStatus } from "@/data/travel-calendar";

// Re-resolve the travel calendar hourly so the board rolls over on its own.
          ...
          <div className='h-[60vh] md:h-[calc(100vh-7.5rem)] md:w-[60vw] flex items-center mx-10 md:mx-15 lg:mx-32 relative'>
            <div>
              ...
              <div className="flex flex-row gap-3 md:gap-6 items-center">
                ...
                <a href="https://www.instagram.com/ebuka.mp4/" target="_blank"><AiFillInstagram size={45} className="text-[#cd9272] size-7 md:size-11"/></a>
